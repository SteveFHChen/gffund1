...
document.write('<script type="text/javascript" src="'+getRelativeUrl('scripts/lib/jquery.validator.js')+'" ></script>');
document.write('<script type="text/javascript" src="'+getRelativeUrl('scripts/lib/swfupload/swfupload.js')+'" ></script>');
